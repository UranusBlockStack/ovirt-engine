...
public enum AuditLogType {
    ...
    SCHEDULE_VMRUN(11001),
    SCHEDULE_VMSUSPEND(11002),
    SCHEDULE_VMSTOP(11003),
    SCHEDULE_VMREBOOT(11004),
    SCHEDULE_VMBACKUP(11005),
    SCHEDULE_VMSNAPSHOT(11006),
    SCHEDULE_VMTEMPLATE(11007),
    SCHEDULE_VDSSTART(11008),
    SCHEDULE_VDSREBOOT(11009),
    SCHEDULE_VDSREBOOT(11009),
    SCHEDULE_VDSMAINTENANCE(11011),
    SCHEDULE_VDSACTIVATE(11012),
